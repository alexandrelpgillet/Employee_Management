...
int buscar_funcionario(Funcionario *Dados)
{
    ...
    {   
         ...
         printf("DIGITE O NOME DO FUNCIONARIO QUE DESEJA ENCONTRAR OU O DEPARTAMENTO CUJO OS FUNCIONARIOS VOCE DESEJA BUSCAR OU O CARGO DOS FUNCIONARIOS QUE VOCE DESEJA BUSCAR\n");

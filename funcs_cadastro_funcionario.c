...
void cadastro_funcionario(Funcionario *Dados)
{
    ...
    while(menu_editar_cadastro)
    {
        ...
        printf("CASO QUEIRA EDITAR ALGUMA INFORMACAO DIGITE O NUMERO CORRESPONDENTE A NUMERACAO DOS ITENS(1-NOME , 2-DEPARTAMENTO , 3 - CARGO , 4 - SALARIO) , CASO NAO QUEIRA EDITAR DIGITE ENTER\n");
